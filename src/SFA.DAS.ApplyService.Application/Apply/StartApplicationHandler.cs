...
namespace SFA.DAS.ApplyService.Application.Apply
{
    public class StartApplicationHandler : IRequestHandler<StartApplicationRequest, StartApplicationResponse>
    {
        ...
        public async Task<StartApplicationResponse> Handle(StartApplicationRequest request, CancellationToken cancellationToken)
        {
            ...
            var org = await _organisationRepository.GetUserOrganisation(request.CreatingContactId);
            ...
            if (org != null && creatingContact != null)
            {
                ...
                applicationId = await _applyRepository.CreateApplication(request.ApplicationId, applyData, org.Id, creatingContact.Id);
            }
